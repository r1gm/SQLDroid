...
public class SQLDroidConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new SQLDroidPreparedStatement(sql, this, columnNames);
    }
     ...
     * database when executing an INSERT statement or create a new prepare
     * statement and then return that.
     *
     * @throws SQLException
     */
