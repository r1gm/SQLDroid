        ...
        try {
            ...
            switch (md.getColumnType(index)) {
                ...
                default:
                    ...
                    try {
                        SimpleDateFormat dateFormat = new SimpleDateFormat(SQLiteDatabase.DATE_PATTERN);
    ...
    public Object getObject(int colID) throws SQLException {
        ...
        switch (SQLDroidResultSetMetaData.getType(c, newIndex)) {
            ...
            case Cursor.FIELD_TYPE_INTEGER:
                //Hack fix, better than not valid data
    ...
    public Time getTime(int index) throws SQLException {
        try {
            ...
            switch (getMetaData().getColumnType(index)) {
                ...
                case Types.INTEGER:
                case Types.BIGINT:
                    return new Time(getLong(index));
                //case Types.DATE:
                //    return new Time(getDate(index).getTime());
                default:
                    // format 2011-07-11 11:36:30.009 OR 2011-07-11 11:36:30
                    SimpleDateFormat dateFormat = new SimpleDateFormat(SQLiteDatabase.TIME_PATTERN);
                    SimpleDateFormat dateFormatNoMillis = new SimpleDateFormat(SQLiteDatabase.TIME_PATTERN_NO_MILLIS);
                    try {
                        return new Time(dateFormat.parse(getString(index)).getTime());
                    } catch (ParseException e) {
                        try {
                            return new Time(dateFormatNoMillis.parse(getString(index)).getTime());
    ...
    public Timestamp getTimestamp(int index) throws SQLException {
        try {
            ...
            switch (getMetaData().getColumnType(index)) {
                ...
                default:
                    // format 2011-07-11 11:36:30.009 OR 2011-07-11 11:36:30
                    SimpleDateFormat dateFormat = new SimpleDateFormat(SQLiteDatabase.TIMESTAMP_PATTERN);
                    SimpleDateFormat dateFormatNoMillis = new SimpleDateFormat(SQLiteDatabase.TIMESTAMP_PATTERN_NO_MILLIS);
                    try {
