...
public class SQLiteDatabase {
    ...
    public static final String TIME_PATTERN_NO_MILLIS = "HH:mm:ss";

    public static final String TIMESTAMP_PATTERN = "yyyy-MM-dd HH:mm:ss.SSS";
    public static final String TIMESTAMP_PATTERN_NO_MILLIS = "yyyy-MM-dd HH:mm:ss";
     ...
     * @param timeout
     * @param retryInterval
     * @throws SQLException thrown if the attempt to connect to the database
     * throws an exception other than a locked exception or throws a locked
     ...
     *
     * @throws SQLException thrown if the timeout expires before the method
